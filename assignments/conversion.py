...
class App(Frame):
    ...
    def create_widgets(self):
        ...
        Button(self, text="지우기", command=self.clear).grid(row=1, column=2, columnspan=2)
        #센티미터 피트
        ...
        Button(self, text="변환", command=self.centi2feet).grid(row=5, column=0)
        Button(self, text="변환", command=self.feet2centi).grid(row=5, column=1)
        Button(self, text="지우기", command=self.clear).grid(row=4, column=2, columnspan=2)
        #킬로그램 파운드
        ...
        Button(self, text="변환", command=self.kilo2pound).grid(row=8, column=0)
        Button(self, text="변환", command=self.pound2kilo).grid(row=8, column=1)
        Button(self, text="지우기", command=self.clear).grid(row=7, column=2, columnspan=2)


        #종료버튼
        Button(self, text="종료", command=self.quit).grid(row=9, column=0, columnspan=2)
